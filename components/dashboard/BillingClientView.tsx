...
export default function BillingClientView({
  ...
  const [currentSub, setCurrentSub] = useState<Subscription | null>(initialSub);
    ...
    <>
      ...
      {showCheckout.open && (
         <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-0 animate-in fade-in duration-300">
            ...
            ></div>
            <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-md relative z-10 overflow-hidden animate-in zoom-in-95 duration-300">
      ...
      {showInvoice.open && showInvoice.tx && (
         <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 animate-in fade-in duration-300">
            ...
            ></div>
            <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-2xl relative z-10 overflow-hidden animate-in zoom-in-95 duration-500">
               <div className="p-12">
                  ...
                  <div className="grid grid-cols-2 gap-12 mb-12">
                     ...
                     <div className="text-right">
                        ...
                        <p className="text-sm font-black text-zinc-800">
                          {new Date(showInvoice.tx.createdAt).toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}
                        </p>
                     </div>
                  </div>
